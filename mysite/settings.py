"""
Django settings for our generic project.
...
ALLOWED_HOSTS = [
    f"www.{PROJ_NAME}.com",
    f"{PROJ_NAME}.pythonanywhere.com",
    "127.0.0.1",
    "0.0.0.0",
]
...
if use_mysql is not None and use_mysql is not False:
    DATABASES = {
        "default": {
            ...
            "NAME": os.environ.get("NAME", PROJ_NAME),
...
LOGIN_REDIRECT_URL = f"{PROJ_NAME}:landing_page"
